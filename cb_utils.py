...
def invoke_cbr(CBRAPI, hostname, module, ioc_name_list, output_path):
	ERROR_MSG=""
	CBLR_ERROR_MSG=""
	OUTPUT_MSG=""
	STATE="Unknown"
...
def invoke_function(CBRAPI, function, module, hosts, logfile, output_path, workers, iocs):
	...
	futures = [executor.submit(function, CBRAPI, SENSOR, module, iocs, output_path) for SENSOR in SENSOR_LIST]
	temp_list=[]
